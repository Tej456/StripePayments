...
{
    public DbSet<Book> Products => Set<Book>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var productsToSeed = new Book[amountOfProductsToSeed];

        for (int i = 1; i <= amountOfProductsToSeed; i++)
        {
            productsToSeed[i - 1] = new Book
            {
        ...
        modelBuilder.Entity<Book>().HasData(productsToSeed);
    }
}
